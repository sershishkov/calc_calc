...
import DividerSimple from '@/components/ui/excerises/DividerSimple';
import DividentDigit from '@/components/ui/excerises/DividentDigit';
import InputDividentHint from '@/components/ui/inputs/InputDividentHint';
import InputDigitDivisionQuotient from '@/components/ui/inputs/InputDigitDivisionQuotient';
import InputNumberDivisionRem from '@/components/ui/inputs/InputNumberDivisionRem';

import {
  GenExampleDivBySimpleNumber,
  GenExampleDivByMultipliers,
} from '@/utils/generateExample';

function WrapForInputQuatent({
  children,
...
function ExerciseDivisionSimple({
  ...
  example: GenExampleDivBySimpleNumber | GenExampleDivByMultipliers;
  onAnswer: () => void;
                ...
                <TableCell>
                  <DividerSimple>
                    {example && showMiddleRow
                      ? example instanceof GenExampleDivByMultipliers
                        ? `${example.divider_1}`
                        : '0'
                      : example && !showMiddleRow
